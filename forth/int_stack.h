...
extern int int_stack_two_swap(int_stack_t *stk);
extern int int_stack_two_dup(int_stack_t *stk);
extern int int_stack_two_over(int_stack_t *stk);
extern int int_stack_two_drop(int_stack_t *stk);
